...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{cases}
		\end{displaymath}
		\item  if $ \mathcal{C} $ is returned by \eqref{win_interm} {\color{purple} just $x \mod ..$? It seems that $x$ may remain constant with this definition, are you sure that this is correct?}:
		\begin{displaymath}
		x^+ = \begin{cases}
