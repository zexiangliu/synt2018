...
In regards to the patching operator in \eqref{patch_inv}, we have the following result, proof of which is given in Appendix \ref{app:pr_31}:
...
\begin{figure}
	...
	\caption{Hopping robots with point foot on a ground with holes. {\color{purple} Remark: the linear-inverted pendulum model assumes that the center of mass remains }}
	\label{fig:hoprob}
\end{figure}
